...
## Data for Table WA1
tPRInf <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPRUni <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR1Inf <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR1Uni <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR2Inf <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR2Uni <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR3Inf <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR3Uni <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR13Inf <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPR13Uni <- str_replace(as.character(format(round(t.test((LimitVolume>0 | Volume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVolInf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVolUni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol1Inf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol1Uni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol2Inf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol2Uni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol3Inf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol3Uni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol13Inf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol13Uni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVolInf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVolUni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol1Inf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol1Uni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Period < 4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol2Inf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol2Uni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>3 & Period < 10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol3Inf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol3Uni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol13Inf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol13Uni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase != "Phase 2" & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")

dat_textPR <- data.frame(
  label = c(paste0(" = ",tPR1Inf,""), paste0(" = ",tPR1Uni,""), paste0(" = .",tPR2Inf,"000"), paste0(" = ",tPR2Uni,""), paste0(" = ",tPR3Inf,""),paste0(" = ",tPR3Uni,""),paste0(" = ",tVol1Inf,""),paste0(" = ",tVol1Uni,""),paste0(" = .",tVol2Inf,"000"),paste0(" = .",tVol2Uni,"000"),paste0(" = ",tVol3Inf,""),paste0(" = ",tVol3Uni,"")),
...
ggplot(data=subset(avgtraderphasesummary2, variable == "Volume" | variable =="PR"), aes(y= value, x= Role, group=(IsREG), fill = IsREG)) +
    ...
    labs(y="") +
    geom_text(data = subset(dat_textPR, Variable == "Participation rate"), mapping = aes(x = Role, y = 1.13 + 1.7*vjust, label = p), color = "black", size = 5, fontface = "italic", hjust = 4.5) +
    geom_text(data = subset(dat_textPR, Variable == "Participation rate"), mapping = aes(x = Role, y = 1.13 + 1.7*vjust, label = label), color = "black", size = 5) +
    geom_text(data = subset(dat_textPR, Variable == "Traders' mean trading volume"), mapping = aes(x = Role, y = 1.06 + 1.7*vjust, label = p), color = "black", size = 5, fontface = "italic", hjust = 4.5) +
    geom_text(data = subset(dat_textPR, Variable == "Traders' mean trading volume"), mapping = aes(x = Role, y = 1.06 + 1.7*vjust, label = label), color = "black", size = 5) +
    theme(text = element_text(size=18), axis.title.x = element_blank(), legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill = "transparent"), strip.text = element_text(size=18), strip.placement = "outside", strip.clip = "off") +
    facet_grid(Variable ~ Phase, scales = "free", switch = "y") +
    ...
    geom_errorbar(aes(ymin = dol, ymax = upl), width=.2, color = 'black', position=position_dodge(width=0.5), linewidth = 0.7) + 
    geom_blank(aes(y= 1.19))
#dev.off()
```
...
ptPRUni <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPRInf <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR1Uni <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR1Inf <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR2Uni <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR2Inf <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR3Uni <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
ptPR3Inf <- str_replace(as.character(format(round(prop.test(c(t1,t2), c(t1s,t2s))$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  tVolTreatInf <- str_replace(as.character(format(round(t.test(as.numeric(Volume>0 & LimitVolume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Informed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  tVolTreatUni <- str_replace(as.character(format(round(t.test(as.numeric(Volume>0 & LimitVolume>0) ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Uninformed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
tVolM <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol1M <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol2M <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol3M <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol13M <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVolM <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol1M <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol2M <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol3M <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol13M <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")

tVolInf <- str_replace(as.character(format(round(t.test(VolumeInf ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVolUni <- str_replace(as.character(format(round(t.test(VolumeUni ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol1Inf <- str_replace(as.character(format(round(t.test(VolumeInf ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol1Uni <- str_replace(as.character(format(round(t.test(VolumeUni ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol2Inf <- str_replace(as.character(format(round(t.test(VolumeInf ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol2Uni <- str_replace(as.character(format(round(t.test(VolumeUni ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol3Inf <- str_replace(as.character(format(round(t.test(VolumeInf ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol3Uni <- str_replace(as.character(format(round(t.test(VolumeUni ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol13Inf <- str_replace(as.character(format(round(t.test(VolumeInf ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tVol13Uni <- str_replace(as.character(format(round(t.test(VolumeUni ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVolInf <- str_replace(as.character(format(round(t.test(LimitVolumeInf ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVolUni <- str_replace(as.character(format(round(t.test(LimitVolumeUni ~ IsREG, data=subset(marketsummary, Period>0), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol1Inf <- str_replace(as.character(format(round(t.test(LimitVolumeInf ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol1Uni <- str_replace(as.character(format(round(t.test(LimitVolumeUni ~ IsREG, data=subset(marketsummary, Period>0 & Period < 4), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol2Inf <- str_replace(as.character(format(round(t.test(LimitVolumeInf ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol2Uni <- str_replace(as.character(format(round(t.test(LimitVolumeUni ~ IsREG, data=subset(marketsummary, Period>3 & Period < 10), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol3Inf <- str_replace(as.character(format(round(t.test(LimitVolumeInf ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol3Uni <- str_replace(as.character(format(round(t.test(LimitVolumeUni ~ IsREG, data=subset(marketsummary, Period>9), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol13Inf <- str_replace(as.character(format(round(t.test(LimitVolumeInf ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tLimitVol13Uni <- str_replace(as.character(format(round(t.test(LimitVolumeUni ~ IsREG, data=subset(marketsummary, Period>0 & Phase != "Phase 2"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
dt1 <- str_replace(as.character(format(round(t.test(Volume_Informed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 1"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt2 <- str_replace(as.character(format(round(t.test(Volume_Informed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 2"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt3 <- str_replace(as.character(format(round(t.test(Volume_Informed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 3"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt4 <- str_replace(as.character(format(round(t.test(Volume_Informed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 1"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt5 <- str_replace(as.character(format(round(t.test(Volume_Informed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 2"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt6 <- str_replace(as.character(format(round(t.test(Volume_Informed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 3"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt7 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 1"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt8 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 2"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt9 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Informed ~ IsREG, data=subset(marketsummary, Phase == "Phase 3"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt10 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 1"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt11 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 2"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
dt12 <- str_replace(as.character(format(round(t.test(Volume_Uninformed_Uninformed ~ IsREG, data=subset(marketsummary, Phase == "Phase 3"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")

dat_text <- data.frame(
  label = c(paste0(" = ",dt1,""), paste0(" = ",dt2,""), paste0(" = ",dt3,""), paste0(" = ",dt4,""), paste0(" = .",dt5,"000"),paste0(" = ",dt6,""),paste0(" = ",dt7,""),paste0(" = .",dt8,"000"),paste0(" = ",dt9,""),paste0(" = ",dt10,""),paste0(" = ",dt11,"0"),paste0(" = ",dt12,"")),
  IsREG = c("REG", "REG", "NOREG", "NOREG", "REG", "REG", "NOREG", "NOREG", "REG", "REG", "NOREG", "NOREG"),
...
ggplot(data=u, aes(y= Volume, x= type, group=interaction(embTreatment, IsREG), fill = IsREG, color = type)) +
  ...
  geom_errorbar(aes(ymin = ll, ymax = ul), width=.2, color = 'black', position=position_dodge(width=0.5), linewidth = 0.7) +
  theme(text = element_text(size=18),axis.title.x=element_blank(),legend.title = element_blank(), legend.position = "bottom", legend.direction = "vertical", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.text = element_text(size = 18)) +
...
uT$variablename <- "Markets' mean trading volume"
...
ggplot(data=subset(uT, Phase == "Phase 2"), aes(y= Volume, x= type, group=interaction(IsREG), fill = IsREG, color = type)) +
  labs(y = "") +
  geom_bar(stat="identity", position = position_dodge(width = 0.5))+  
  geom_text(data = subset(dat_text, Phase == "Phase 2"), mapping = aes(x = type, y = 67, label = p), color = "black", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(dat_text, Phase == "Phase 2"), mapping = aes(x = type, y = 67, label = label), color = "black", size = 5) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.title = element_blank(), legend.position = "bottom", legend.direction = "vertical", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill="transparent"), strip.text = element_text(size=18), strip.placement = "outside") +
  facet_grid(variablename ~ Phase,scales = "free", switch = "y") +
  scale_fill_manual( values = c("NOREG" = rgb(.46, .76, .88), "REG" = rgb(0,.29,.51))) +
  scale_colour_manual(name = "", values = c(0,0,0,0), labels = c("ii  = informed accepted from informed", "iu = informed accepted from uninformed", "ui = uninformed accepted from informed", "uu = uninformed accepted from uninformed")) +
  guides(color = guide_legend(keywidth = unit(0,"mm"))) +
  geom_errorbar(aes(ymin = ll, ymax = ul), width=.2, color = 'black', position=position_dodge(width=0.5), linewidth = 0.7) +
...
```{r RoleTradeallT, echo=F, fig.cap = "Mean market trading volume by combination of trading partners and regulatory regime (Figure WA1).", warning=F}
#postscript("Figures/GraphvolumeRoleallT.eps")
ggplot(data=subset(uT), aes(y= Volume, x= type, group=interaction(IsREG), fill = IsREG, color = type)) +
  labs(y = "") +
  geom_bar(stat="identity", position = position_dodge(width = 0.5))+  
  geom_text(data = subset(dat_text), mapping = aes(x = type, y = 78, label = p), color = "black", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(dat_text), mapping = aes(x = type, y = 78, label = label), color = "black", size = 5) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.title = element_blank(), legend.position = "bottom", legend.direction = "vertical", legend.text = element_text(size=18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill="transparent"), strip.text = element_text(size=18), strip.placement = "outside") +
  facet_grid(variablename ~ Phase,scales = "free", switch = "y") +
  scale_fill_manual( values = c("NOREG" = rgb(.46, .76, .88), "REG" = rgb(0,.29,.51))) +
  scale_colour_manual(name = "", values = c(0,0,0,0), labels = c("ii  = informed accepted from informed", "iu = informed accepted from uninformed", "ui = uninformed accepted from informed", "uu = uninformed accepted from uninformed")) +
...
ta <- data.frame("all" = c(str_replace(as.character(t1$`Pr(>F)`[2]), "^0\\.", "."), str_replace(as.character(t2$`Pr(>F)`[2]), "^0\\.", "."), str_replace(as.character(t3$`Pr(>F)`[2]), "^0\\.", ".")), 
                "center" = c(str_replace(as.character(t4$`Pr(>F)`[2]), "^0\\.", "."), NA,NA),
                "end" = c(NA, str_replace(as.character(t5$`Pr(>F)`[2]), "^0\\.", "."), str_replace(as.character(t6$`Pr(>F)`[2]), "^0\\.", ".")))
...
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  tVolTreatInf <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Informed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  tVolTreatUni <- str_replace(as.character(format(round(t.test(Volume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Uninformed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_VolTreat[i,] <- as.numeric(c(eVolTreatInf, tVolTreatInf, eVolTreatUni, tVolTreatUni))
  i <- i + 1
}}
...
tshortInf <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshortUni <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort1Inf <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort1Uni <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort2Inf <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort2Uni <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort3Inf <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort3Uni <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort13Inf <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tshort13Uni <- str_replace(as.character(format(round(t.test(shortsells ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
tmarginInf <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmarginUni <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin1Inf <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin1Uni <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin2Inf <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin2Uni <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin3Inf <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin3Uni <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin13Inf <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin13Uni <- str_replace(as.character(format(round(t.test(marginbuysAsset ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")


dat_textLimit <- data.frame(
  label = c(paste0(" = ",tLimitVol1Inf,""),paste0(" = ",tLimitVol1Uni,""),paste0(" = .",tLimitVol2Inf,"000"),paste0(" = ",tLimitVol2Uni,""),paste0(" = ",tLimitVol3Inf,""), paste0(" = ",tLimitVol3Uni,""),
  paste0(" = ",tshort1Inf,""),paste0(" = ",tshort1Uni,""),paste0(" = ",tshort2Inf,""),paste0(" = ",tshort2Uni,""),paste0(" = ",tshort3Inf,"0"), paste0(" = ",tshort3Uni,""),
  paste0(" = ",tmargin1Inf,""),paste0(" = .",tmargin1Uni,"000"),paste0(" = ",tmargin2Inf,""),paste0(" = ",tmargin2Uni,""),paste0(" = ",tmargin3Inf,""), paste0(" = ",tmargin3Uni,"")),
  ...
  p = c("p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p")
  )
...
ggplot(data=subset(avgtraderphasesummary2, variable == "LimitVolume" | variable == "shortsells" | variable == "marginbuysAsset"), aes(y= value, x= Role, group=(IsREG), fill = IsREG)) +
  geom_bar(stat="identity", position = position_dodge(width = 0.5))+ 
  labs(y="") +
  geom_text(data = subset(dat_textLimit), mapping = aes(x = Role, y = vjust, label = p), color = "black", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(dat_textLimit), mapping = aes(x = Role, y = vjust, label = label), color = "black", size = 5) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"),  plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill = "transparent"), strip.text = element_text(size=18), strip.placement = "outside") +
  facet_grid(factor(Variable, levels = c("Limit volume", "Short sells", "Margin buys")) ~ Phase, scales = "free", switch = "y") +
  scale_fill_manual( values = c("NOREG" = rgb(.46, .76, .88), "REG" = rgb(0,.29,.51))) +
  scale_color_manual( values = c("NOREG" = rgb(.46, .76, .88), "REG" = rgb(0,.29,.51))) +
  geom_errorbar(aes(ymin = dol, ymax = upl), width=.2, color = 'black', position=position_dodge(width=0.5), linewidth = 0.7)
#dev.off()
...
ta<- data.frame("all" = c(str_replace(as.character(format(t1$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", "."), str_replace(as.character(format(t2$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", "."), str_replace(as.character(format(t3$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", ".")), 
                "center" = c(str_replace(as.character(format(t4$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", "."), NA,NA),
                "end" = c(NA, str_replace(as.character(format(t5$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", "."), str_replace(as.character(format(t6$`Pr(>F)`[2],  digits = 3, scientific = 5)), "^0\\.", ".")))
rownames(ta) <- c("1$^{st}$ phase effect in the 2$^{nd}$ phase", "1$^{st}$ phase effect in the 3$^{rd}$ phase", "2$^{nd}$ phase effect")
...
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  tVolTreatInf <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Informed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  tVolTreatUni <- str_replace(as.character(format(round(t.test(LimitVolume ~ IsREG, data=subset(subjectsummary, Period>0 & Phase == "Phase 2" & embTreatment == t & Role== "Uninformed trader"), paired = T, var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_VolTreat[i,] <- as.numeric(c(eVolTreatInf, tVolTreatInf, eVolTreatUni, tVolTreatUni))
  i <- i + 1
}}
...
v <- aggregate(cbind(log(odds) - log(odds_start), log(oddsLimit) - log(oddsLimit_start), geomodds-geomodds_start, geomoddsLimit-geomoddsLimit_start, geomodds)  ~ Role + embTreatment, data = subset(phasesummary, Phase == "Phase 2" & IsREG == "NOREG"), function(x) mean(x))
  ...
  v$variablename <- paste0("'Difference in ln(odds'['Phase']~')'")
...
#postscript("Figures/GraphmigrationTreat.eps")  
  ...
  geom_errorbar(aes(ymin=ll, ymax=ul, color=factor(Role)), width=.2, linewidth = 0.7) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.position = "none", panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"),  plot.background = element_rect(fill = "transparent"), strip.text = element_text(size = 18)) +
  facet_grid(y ~ embTreatment,scales = "free", labeller = label_parsed) +
  scale_fill_manual(values = c("All traders" = rgb(.86,.35,0), "Informed\ntraders" = rgb(1,.73,.31), "Uninformed\ntraders" = rgb(1,.73,.31))) + 
...
ggplot(data=subset(v, embTreatment == "All treatments"), aes(y=d, x= Role, group=y, fill = Role)) +
  ...
  labs(y="") +
  geom_errorbar(aes(ymin=ll, ymax=ul, color=factor(Role)), width=.2, linewidth = 0.7) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.position = "none", panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"),  plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill = "transparent"), strip.text = element_text(size=18), strip.placement = "outside") +
  facet_grid(variablename ~ y,scales = "free", labeller = label_parsed, switch = "y") +
  scale_fill_manual( values = c("All traders" = rgb(.86,.35,0), "Informed\ntraders" = rgb(1,.73,.31), "Uninformed\ntraders" = rgb(1,.73,.31))) + 
  scale_color_manual("Role", values=c("dimgrey","black", "black", "dimgrey")) +
  geom_blank(aes(y= -.9))
#dev.off()
...
```{r tableOdds, echo =F}
taOdds <- data.frame("Diff~0 Phase1~Phase2" = c(paste0("V=", w0M1$statistic, ", p =", str_replace(as.character(format(w0M1$p.value, digits = 2, scientific = 5)), "^0\\.", ".")), paste0("V=", w0I1$statistic, ", p =", str_replace(as.character(format(w0I1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", w0U1$statistic, ", p =", str_replace(as.character(format(w0U1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", wR1$statistic, ", p =", str_replace(as.character(format(wR1$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff~0 Phase2~Phase3" = c(paste0("V=", w0M3$statistic, ", p =", str_replace(as.character(format( w0M3$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", w0I3$statistic, ", p =", str_replace(as.character(format(w0I3$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", w0U3$statistic, ", p =", str_replace(as.character(format(w0U3$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", wR3$statistic, ", p =", str_replace(as.character(format(wR3$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff Phase1~Phase3" = c(paste0("V=", wPM$statistic, ", p =", str_replace(as.character(format(wPM$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wPI$statistic, ", p =", str_replace(as.character(format(wPI$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wPU$statistic, ", p =", str_replace(as.character(format(wPU$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("")), 
                "Treat diff Phase1&Phase3" = c(paste0("H=", format(kTM13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kTM13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("H=", format(kTI13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kTI13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("H=", format(kTU13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kTU13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("")))
...
#postscript("Figures/Graphgeomodds.eps") 
  ...
  geom_bar(stat="identity") +  
  labs(y=expression("Difference in ln(odds)"["geom"])) +
  geom_errorbar(aes(ymin=llP, ymax=ulP, color=factor(Role)), width=.2, linewidth = 0.7) +
  theme(text = element_text(size=18),axis.title.x=element_blank(), legend.position = "none", panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.text = element_text(size = 18)) +
  facet_grid(y ~ embTreatment,scales = "free", labeller = label_parsed) +
  scale_fill_manual(values = c("All traders" = rgb(.86,.35,0), "Informed\ntraders" = rgb(1,.73,.31), "Uninformed\ntraders" = rgb(1,.73,.31))) + 
  scale_color_manual("Role", values=c("dimgrey","black", "black", "dimgrey")) +
...
tageomodds <- data.frame("Diff~0 Phase1~Phase2" = c(paste0("V=", wg0M1$statistic, ", p =", str_replace(as.character(format(wg0M1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", wg0I1$statistic, ", p =", str_replace(as.character(format(wg0I1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", wg0U1$statistic, ", p =", str_replace(as.character(format(wg0U1$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wgR1$statistic, ", p =", str_replace(as.character(format(wgR1$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff~0 Phase2~Phase3" = c(paste0("V=", wg0M3$statistic, ", p =", str_replace(as.character(format(wg0M3$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wg0I3$statistic, ", p =", str_replace(as.character(format(wg0I3$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("V=", wg0U3$statistic, ", p =", str_replace(as.character(format(wg0U3$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wgR3$statistic, ", p =", str_replace(as.character(format(wgR3$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff Phase1~Phase3" = c(paste0("V=", wgPM$statistic, ", p =", str_replace(as.character(format(wgPM$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wgPI$statistic, ", p =", str_replace(as.character(format(wgPI$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("V=", wgPU$statistic, ", p =", str_replace(as.character(format(wgPU$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("")), 
                "Treatment diff Phase1&Phase3" = c(paste0("H=", format(kgTM13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kgTM13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("H=", format(kgTI13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kgTI13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("H=", format(kgTU13$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(kgTU13$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("")))
...
tageomodds <- data.frame("Diff~0 Phase1~Phase2" = c(paste0("t=", format(tg0M1$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0M1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tg0I1$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0I1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tg0U1$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0U1$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tgR1$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tgR1$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff~0 Phase2~Phase3" = c(paste0("t=", format(tg0M3$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0M3$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tg0I3$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0I3$p.value, digits = 1, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tg0U3$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tg0U3$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tgR3$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tgR3$p.value, digits = 1, scientific = 5)), "^0\\.", "."))),
                "Diff Phase1~Phase3" = c(paste0("t=", format(tgPM$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tgPM$p.value, digits = 2, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tgPI$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tgPI$p.value, digits = 3, scientific = 5)), "^0\\.", ".")), paste0("t=", format(tgPU$statistic, digits = 4, scientific = 5), ", p =", str_replace(as.character(format(tgPU$p.value, digits = 4, scientific = 5)), "^0\\.", ".")), paste0("")))
...
dat_oddsTreat <- matrix(data = NA, ncol = 9, nrow = 4)
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 1") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
dat_oddsTreat <- matrix(data = NA, ncol = 9, nrow = 4)
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3")), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_oddsTreat[1,] <- as.numeric(c(eoddsTreat, toddsTreat, eoddsTreatInf, toddsTreatInf, eoddsTreatUni, toddsTreatUni))
i <- 2
while(i<5){
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 2" | Phase == "Phase 3") & embTreatment == t), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_oddsTreat[i,] <- as.numeric(c(eoddsTreat, toddsTreat, eoddsTreatInf, toddsTreatInf, eoddsTreatUni, toddsTreatUni))
  i <- i + 1
}}
...
dat_oddsTreat <- matrix(data = NA, ncol = 9, nrow = 4)
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3")), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3")), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3")), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_oddsTreat[1,] <- as.numeric(c(eoddsTreat, toddsTreat, eoddsTreatInf, toddsTreatInf, eoddsTreatUni, toddsTreatUni))
i <- 2
while(i<5){
for(t in c("NN.RR", "RR.NN", "RR.RR")){
  ...
  toddsTreat <- str_replace(as.character(format(round(t.test(log(odds) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3") & embTreatment == t), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatInf <- str_replace(as.character(format(round(t.test(log(oddsInfmax) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3") & embTreatment == t), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  ...
  toddsTreatUni <- str_replace(as.character(format(round(t.test(log(oddsUninf) ~ Phase, data=subset(marketsummary, Period>0 & ((regOrder == "NTop" & market == "Top") | (regOrder == "RTop" & market == "Bottom")) & (Phase == "Phase 1" | Phase == "Phase 3") & embTreatment == t), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
  dat_oddsTreat[i,] <- as.numeric(c(eoddsTreat, toddsTreat, eoddsTreatInf, toddsTreatInf, eoddsTreatUni, toddsTreatUni))
  i <- i + 1
}}
...
ggplot(data = fitbash2) +
  ...
  labs(colour = " ") + ylab("Spread") + xlab('Time (seconds)') + ylim(0,NA) +
  scale_color_manual( values = c("NOREG" = rgb(.46, .76, .88), "REG" = rgb(0,.29,.51))) +
  theme(text = element_text(size = 18), axis.text.y.right = element_text(color = "darkgrey"), axis.title.y.right = element_text(color = "darkgrey"), legend.position = "bottom", legend.text = element_text(size = 18))
#dev.off()
```
...
### Figure 5 ####
# Data for Table WA9 ##
tPDbeforeInf <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeUni <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore1Inf <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore1Uni <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore2Inf <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore2Uni <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore3Inf <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbefore3Uni <- str_replace(as.character(format(round(t.test(PDbefore ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunInf <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunUni <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun1Inf <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun1Uni <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun2Inf <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun2Uni <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun3Inf <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPun3Uni <- str_replace(as.character(format(round(t.test(PDPun ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
datPD_text <- data.frame(
  label = c(paste0(" = ", tPDbefore1Inf,"0"), paste0(" = ", tPDbefore1Uni,""), paste0(" = ",tPDbefore2Inf,""), paste0(" = ",tPDbefore2Uni,""), paste0(" = ",tPDbefore3Inf,"0"),paste0(" = ",tPDbefore3Uni,""),paste0(" = ",tPDPun1Inf,""),paste0(" = ",tPDPun1Uni,""),paste0(" = .",tPDPun2Inf,"000"),paste0(" = ",tPDPun2Uni,""),paste0(" = ",tPDPun3Inf,""),paste0(" = ",tPDPun3Uni,"")),
...
avgtraderphasesummary2$variablename <- "Mean gross trading profits per trader"
...
ggplot(data=subset(avgtraderphasesummary2, variable == "PDbefore" | ( IsREG != "NOREG" & variable =="PDPun")), aes(y= value*100, x= Role, group = group, fill = group, color = group)) +
  ...
  labs(y="") +
  geom_text(data = subset(datPD_text[1:6,]), mapping = aes(x = Role, y = 5.5 - vjust, label = p), col = "black", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(datPD_text[1:6,]), mapping = aes(x = Role, y = 5.5 - vjust, label = label), col = "black", size = 5) +
  geom_text(data = subset(datPD_text[7:12,]), mapping = aes(x = Role, y = 5.45 - vjust*100, label = p), col = "orange", size = 5, hjust = 4.5, fontface = "italic") +
  geom_text(data = subset(datPD_text[7:12,]), mapping = aes(x = Role, y = 5.45 - vjust*100, label = label), col = "orange", size = 5) +
  geom_errorbar(aes(ymin = dol*100, ymax = upl*100), width=.2, color = 'black', linewidth = .7, position=position_dodge(width=0.7)) +
  theme(text = element_text(size=18), axis.title.x=element_blank(),legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill = "transparent"), strip.placement = "outside", strip.text = element_text(size=18)) +
  facet_grid(variablename ~ Phase, scales = "free", switch = "y") +
...
ggplot(data=subset(avgtraderphasesummaryRank2, variable == "PDbefore" | ( IsREG != "NOREG" & variable =="PDPun")), aes(y= value*100, x= rank2, group = group, fill = group, color = group)) +
    geom_bar(stat="identity", position = position_dodge(width = 0.7), size = 2)+ 
    labs(y="Mean gross trading profits per trader") +
    ...
    geom_errorbar(aes(ymin = dol*100, ymax = upl*100), width=.2, color = 'black', linewidth = .7, position=position_dodge(width=0.7)) +
    theme(text = element_text(size=18),axis.title.x=element_blank(), axis.text.x = element_text(size=12), legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.text = element_text(size = 18)) +
    facet_grid(Role ~ Phase, scales = "free") +
    scale_color_manual(name = "Regime - Punishment", values = c("REG.PDbefore" = "transparent", "NOREG.PDbefore" = "transparent", "REG.PDPun" = "orange"), breaks = c("NOREG.PDbefore", "REG.PDbefore", "REG.PDPun"), labels = c("NOREG", "REG - before punishment", "REG - after punishment")) +
    scale_fill_manual(name = "Regime - Punishment", values = c("NOREG.PDbefore" = rgb(.46, .76, .88), "REG.PDPun" = rgb(0,.29,.51), "REG.PDbefore" = rgb(0,.29,.51)), breaks = c("NOREG.PDbefore", "REG.PDbefore", "REG.PDPun"), labels = c("NOREG", "REG - before punishment", "REG - after punishment"))
#dev.off()
...
# Data for Table WA10 ##
tPDbeforeVolInf <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVolUni <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol1Inf <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol1Uni <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol2Inf <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol2Uni <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol3Inf <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDbeforeVol3Uni <- str_replace(as.character(format(round(t.test(PDbeforeVol ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVolInf <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVolUni <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol1Inf <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol1Uni <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol2Inf <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol2Uni <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol3Inf <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tPDPunVol3Uni <- str_replace(as.character(format(round(t.test(PDPunVol ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
datPDVol_text <- data.frame(
  label = c(paste0(" = ",tPDbeforeVolInf,""), paste0(" = ",tPDbeforeVolUni,""), paste0(" = ",tPDbeforeVol1Inf,""), paste0(" = ",tPDbeforeVol1Uni,""), paste0(" = ",tPDbeforeVol2Inf,""), paste0(" = ",tPDbeforeVol2Uni,""), paste0(" = ",tPDbeforeVol3Inf,""),paste0(" = ",tPDbeforeVol3Uni,""),paste0(" = ",tPDPunVolInf,""),paste0(" = ",tPDPunVolUni,""),paste0(" = ",tPDPunVol1Inf,""),paste0(" = ",tPDPunVol1Uni,""),paste0(" = ",tPDPunVol2Inf,""),paste0(" = ",tPDPunVol2Uni,""),paste0(" = ",tPDPunVol3Inf,""),paste0(" = ",tPDPunVol3Uni,"")),
  ...
  p = c("p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p", "p")
)
avgtraderphasesummary2$variablename <- "Mean trading profits per share and trader"
...
ggplot(data=subset(avgtraderphasesummary2, variable == "PDbeforeVol" | ( IsREG != "NOREG" & variable =="PDPunVol")), aes(y= value, x= Role, group = group, fill = group, color = group)) +
  geom_bar(stat="identity", position = position_dodge(width = 0.7), size = 2) + 
  labs(y="") +
  geom_text(data = subset(datPDVol_text[3:8,]), mapping = aes(x = Role, y = 1.9 - vjust, label = p), col = "black", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(datPDVol_text[3:8,]), mapping = aes(x = Role, y = 1.9 - vjust, label = label), col = "black", size = 5) +
  geom_text(data = subset(datPDVol_text[11:16,]), mapping = aes(x = Role, y = 1.9 - vjust, label = p), col = "orange", size = 5, fontface = "italic", hjust = 4.5) +
  geom_text(data = subset(datPDVol_text[11:16,]), mapping = aes(x = Role, y = 1.9 - vjust, label = label), col = "orange", size = 5) +
  geom_errorbar(aes(ymin = dol, ymax = upl), width=.2, color = 'black', linewidth = .7, position=position_dodge(width=0.7)) +
  theme(text = element_text(size=18), axis.title.x=element_blank(), legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.background.y = element_rect(fill = "transparent"), strip.placement = "outside", strip.text = element_text(size = 18)) +
  facet_grid(variablename ~ Phase, scales = "free", switch = "y") +
...
ggplot(data=subset(coefProfitRank), aes(y= Estimate, x= Rank, group=(variable))) +
    ...
    labs(y="") +
    theme(text = element_text(size=18),axis.title.x=element_blank(),legend.title = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.text = element_text(size = 18), panel.grid.major.y = element_line(colour = "lightgrey"), panel.background = element_rect(fill = "transparent"), plot.background = element_rect(fill = "transparent"), strip.text = element_text(size = 18)) +
    facet_grid(Role ~ Phase, scales = "fixed") +
    geom_errorbar(aes(ymin = Estimate + qt(.025,df)*Std..Error, ymax = Estimate + qt(.975,df)*Std..Error, color = variable), width=.2, position=position_dodge(width=0.5), linewidth = 0.7) +
...
while(i<4){
  for(p in list("Phase 1", "Phase 2", "Phase 3")){
  sN <- str_replace(as.character(format(round(t.test(PDbefore ~ Role, data=subset(subjectsummary, Phase == p & IsREG == "NOREG"), var.equal=F)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
sR <- str_replace(as.character(format(round(t.test(PDbefore ~ Role, data=subset(subjectsummary, Phase == p & IsREG == "REG"), var.equal=F)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
sRp <- str_replace(as.character(format(round(t.test(PDPun ~ Role, data=subset(subjectsummary, Phase == p & IsREG == "REG"), var.equal=F)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
...
tmarginInf2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmarginUni2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>0 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin1Inf2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin1Uni2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>0 & Period<4 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin2Inf2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Informed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin2Uni2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>3 & Period<10 & Role=="Uninformed trader"), var.equal=T, paired = T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin3Inf2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin3Uni2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period>9 & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin13Inf2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Informed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
tmargin13Uni2 <- str_replace(as.character(format(round(t.test(marginbuys ~ IsREG, data=subset(subjectsummary, Period >0 & (Period <4 | Period>9) & Role=="Uninformed trader"), var.equal=T)$p.value, digits = 4), scientific = FALSE)), "^0\\.", ".")
